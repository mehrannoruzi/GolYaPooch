...
namespace GolPooch.DataAccess.Ef.Migrations
{
    ...
    [Migration("20201014081505_Add.ProductOffer_ReFoundsPercent")]
    partial class AddProductOffer_ReFoundsPercent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GolPooch.Domain.Dto.WinnerDto", b =>
                {
                    b.Property<int>("ChanceCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GolPooch.Domain.Entity.ActivityLog", b =>
                {
            ...
            modelBuilder.Entity("GolPooch.Domain.Entity.DiscountCode", b =>
                {
            ...
            modelBuilder.Entity("GolPooch.Domain.Entity.ProductOffer", b =>
                {
                    ...
                    b.Property<float>("ReFoundsPercent")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("GolPooch.Domain.Entity.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("ExpireDateMi")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("GolPooch.Domain.Entity.Round", b =>
                {
                    ...
                    b.Property<DateTime?>("CloseDateMi")
                        .HasColumnType("datetime2");

                    b.Property<string>("CloseDateSh")
                        .HasColumnType("char(10)")
                        .HasMaxLength(10);
                    ...
                    b.Property<DateTime>("DrawDateMi")
                        .HasColumnType("datetime2");

                    b.Property<string>("DrawDateSh")
                        .HasColumnType("char(10)")
                        .HasMaxLength(10);
                    ...
                    b.Property<DateTime?>("OpenDateMi")
                        .HasColumnType("datetime2");

                    b.Property<string>("OpenDateSh")
                        .HasColumnType("char(10)")
                        .HasMaxLength(10);
